    ...
    def __init__(
        ...
        **kwargs
        ...
        if color_code_velocity:
            ...
            # color_slow_to_med = list(self.velocity_colors[0].range_to(self.velocity_colors[1],  + math.floor(slow_to_med_color_weight*)))
            # color_med_to_fast = list(self.velocity_colors[1].range_to(self.velocity_colors[2],  - math.floor(slow_to_med_color_weight*)))
